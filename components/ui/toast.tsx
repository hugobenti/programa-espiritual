...
const ToastContext = React.createContext<{ toasts: any[]; setToasts: React.Dispatch<React.SetStateAction<any[]>> } | null>(null)
...
type LocalToastProps = React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof toastVariants>
const Toast = React.forwardRef<HTMLDivElement, LocalToastProps>(({ className, variant, ...props }, ref) => {
